...
//using AuditLogging.EntityFramework.Extensions;
//using AuditLogging.EntityFramework.Repositories;
//using AuditLogging.EntityFramework.Services;
//using SarveenTech.SmartCattle.BackendSample.Gateway.AuditLogging;
//using SarveenTech.SmartCattle.BackendSample.Gateway.Configuration;
//using SarveenTech.SmartCattle.BackendSample.Gateway.Configuration.ApplicationParts;
//using IdentityServer4.Shared.Configuration;
//using SarveenTech.SmartCattle.BackendSample.Gateway.Helpers.Localization;
//using IdentityServer4.Admin.BusinessLogic.Identity.Dtos.Identity;
//using IdentityServer4.Admin.EntityFramework.Helpers;
//using IdentityServer4.Admin.EntityFramework.Interfaces;
//using IdentityServer4.Admin.EntityFramework.MySql.Extensions;
//using IdentityServer4.Admin.EntityFramework.PostgreSQL.Extensions;
//using IdentityServer4.Admin.EntityFramework.Shared.Configuration;
//using IdentityServer4.Admin.EntityFramework.SqlServer.Extensions;
//using IdentityServer4.Shared.Configuration.Identity;
//using IdentityServer4.Shared.Configuration.Constants;

//namespace SarveenTech.SmartCattle.BackendSample.Gateway.Helpers
//{
...
//                                (c.Type == JwtClaimTypes.Role && adminApiConfiguration.AdministrationRoles.Contains(c.Value)) ||
//                                (c.Type == $"client_{JwtClaimTypes.Role}" && adminApiConfiguration.AdministrationRoles.Contains(c.Value))
//                            )
